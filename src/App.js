...
import { 
    ...
    Atom, Calculator, Dna, BarChart2, Drama, Computer, BookHeart, Landmark, Languages, MessageCircleQuestion
} from 'lucide-react';
...
// --- Curriculum Data ---
const curriculum = {
  'SD': { subjects: [ { name: 'Matematika', icon: <Calculator size={48} className="text-blue-500"/> }, { name: 'IPA', icon: <Atom size={48} className="text-green-500"/> }, { name: 'IPS', icon: <Globe size={48} className="text-orange-500"/> }, { name: 'Bahasa Indonesia', icon: <BookHeart size={48} className="text-red-500"/> }, { name: 'Tanya Segalanya', icon: <MessageCircleQuestion size={48} className="text-purple-500"/> } ] },
  'SMP': { subjects: [ { name: 'Matematika', icon: <Calculator size={48} className="text-blue-500"/> }, { name: 'IPA Terpadu', icon: <FlaskConical size={48} className="text-green-500"/> }, { name: 'IPS Terpadu', icon: <Globe size={48} className="text-orange-500"/> }, { name: 'Bahasa Indonesia', icon: <BookHeart size={48} className="text-red-500"/> }, { name: 'Bahasa Inggris', icon: <Drama size={48} className="text-purple-500"/> }, { name: 'Informatika', icon: <Computer size={48} className="text-gray-600"/> }, { name: 'Tanya Segalanya', icon: <MessageCircleQuestion size={48} className="text-purple-500"/> } ] },
  'SMA': { tracks: { 'IPA': [ { name: 'Matematika Peminatan', icon: <Calculator size={48} className="text-blue-500"/> }, { name: 'Fisika', icon: <Atom size={48} className="text-sky-500"/> }, { name: 'Kimia', icon: <FlaskConical size={48} className="text-green-500"/> }, { name: 'Biologi', icon: <Dna size={48} className="text-teal-500"/> }, { name: 'Tanya Segalanya', icon: <MessageCircleQuestion size={48} className="text-purple-500"/> } ], 'IPS': [ { name: 'Ekonomi', icon: <BarChart2 size={48} className="text-indigo-500"/> }, { name: 'Geografi', icon: <Globe size={48} className="text-orange-500"/> }, { name: 'Sosiologi', icon: <School size={48} className="text-rose-500"/> }, { name: 'Sejarah', icon: <History size={48} className="text-amber-700"/> }, { name: 'Tanya Segalanya', icon: <MessageCircleQuestion size={48} className="text-purple-500"/> } ], 'Bahasa': [ { name: 'Sastra Indonesia', icon: <BookHeart size={48} className="text-red-500"/> }, { name: 'Sastra Inggris', icon: <Drama size={48} className="text-purple-500"/> }, { name: 'Antropologi', icon: <Globe size={48} className="text-orange-500"/> }, { name: 'Bahasa Asing Lain', icon: <Languages size={48} className="text-pink-500"/> }, { name: 'Tanya Segalanya', icon: <MessageCircleQuestion size={48} className="text-purple-500"/> } ] } }
};
